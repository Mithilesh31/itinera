  ...
  const trips = [
    {
      ...
      votes: 42,
      days: [
        { day: 1, title: "Arrive in Tokyo", place: "Shinjuku", notes: "Check in, ramen at Ichiran, explore Shinjuku at night." },
        { day: 1, title: "Shibuya Crossing", place: "Shibuya", time: "8:00 PM" },
        { day: 2, title: "Senso-ji Temple", place: "Asakusa", notes: "Early morning to beat crowds." },
        { day: 3, title: "Bullet train to Kyoto", place: "Kyoto", notes: "Reserve seats in advance." },
        { day: 4, title: "Fushimi Inari", place: "Kyoto", time: "6:30 AM", notes: "Thousands of torii gates — go at sunrise." },
      ],
    },
    {
      owner: maya.id,
      ...
      votes: 38,
      days: [
        { day: 1, title: "Golden Circle", place: "Þingvellir", notes: "Geysir, Gullfoss, and the rift valley." },
        { day: 2, title: "Seljalandsfoss", place: "South Coast", notes: "Walk behind the waterfall." },
        { day: 3, title: "Reynisfjara Beach", place: "Vík", notes: "Black sand + basalt columns." },
      ],
    },
    {
      owner: leo.id,
      ...
      votes: 27,
      days: [
        { day: 1, title: "Alfama walking tour", place: "Lisbon", notes: "Get lost in the old quarter." },
        { day: 2, title: "Belém & pastéis", place: "Belém", time: "10:00 AM" },
        { day: 4, title: "Drive to Lagos", place: "Algarve", notes: "Benagil sea cave by kayak." },
      ],
    },
    {
      owner: demo.id,
      ...
      votes: 19,
      days: [
        { day: 1, title: "The Met", place: "Upper East Side", time: "9:30 AM" },
        { day: 1, title: "Central Park walk", place: "Central Park" },
        { day: 2, title: "Brooklyn Bridge", place: "Brooklyn", notes: "Walk across at sunrise." },
      ],
    },
  ];
